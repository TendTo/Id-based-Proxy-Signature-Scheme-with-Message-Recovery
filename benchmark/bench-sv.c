...
static void bench_p_sign(bench_param_t bench_p)
{
...
static void bench_sign_verify(bench_param_t bench_p)
{
    sv_public_params_t public_p;
    sv_secret_params_t secret_p;
    sv_user_t user;
...
void bench_sv(bench_param_t bench_p)
{
    printf("Benchmarks for the SV implementation...\n");
    bench_p_sign(bench_p);
    bench_sign_verify(bench_p);
}
